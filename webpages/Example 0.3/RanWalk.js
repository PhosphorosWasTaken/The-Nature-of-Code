...
function findWasmBinary() {
  return locateFile('RanWalk.wasm');
}
...
var ASM_CONSTS = {
  89454: () => { if (document.fullscreenElement) return 1; },  
 89500: () => { return Module.canvas.width; },  
 89532: () => { return parseInt(Module.canvas.style.width); },  
 89580: () => { document.exitFullscreen(); },  
 89607: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89679: () => { if (document.fullscreenElement) return 1; },  
 89725: () => { return Module.canvas.width; },  
 89757: () => { return screen.width; },  
 89782: () => { document.exitFullscreen(); },  
 89809: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 90003: () => { return window.innerWidth; },  
 90029: () => { return window.innerHeight; },  
 90056: () => { if (document.fullscreenElement) return 1; },  
 90102: () => { return Module.canvas.width; },  
 90134: () => { return parseInt(Module.canvas.style.width); },  
 90182: () => { if (document.fullscreenElement) return 1; },  
 90228: () => { return Module.canvas.width; },  
 90260: () => { return screen.width; },  
 90285: () => { return window.innerWidth; },  
 90311: () => { return window.innerHeight; },  
 90338: () => { if (document.fullscreenElement) return 1; },  
 90384: () => { return Module.canvas.width; },  
 90416: () => { return screen.width; },  
 90441: () => { document.exitFullscreen(); },  
 90468: () => { if (document.fullscreenElement) return 1; },  
 90514: () => { return Module.canvas.width; },  
 90546: () => { return parseInt(Module.canvas.style.width); },  
 90594: () => { document.exitFullscreen(); },  
 90621: ($0) => { Module.canvas.style.opacity = $0; },  
 90659: () => { return screen.width; },  
 90684: () => { return screen.height; },  
 90710: () => { return window.screenX; },  
 90737: () => { return window.screenY; },  
 90764: () => { return window.devicePixelRatio; },  
 90800: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90853: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90904: () => { Module.canvas.style.cursor = 'none'; },  
 90941: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91197: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91248: () => { if (document.pointerLockElement) return 1; },  
 91295: () => { if (document.fullscreenElement) return 1; },  
 91341: () => { return window.innerWidth; },  
 91367: () => { return window.innerHeight; }
};
