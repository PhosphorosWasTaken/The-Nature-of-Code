...
function findWasmBinary() {
  return locateFile('GaussDistribution.wasm');
}
...
var ASM_CONSTS = {
  89678: () => { if (document.fullscreenElement) return 1; },  
 89724: () => { return Module.canvas.width; },  
 89756: () => { return parseInt(Module.canvas.style.width); },  
 89804: () => { document.exitFullscreen(); },  
 89831: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89903: () => { if (document.fullscreenElement) return 1; },  
 89949: () => { return Module.canvas.width; },  
 89981: () => { return screen.width; },  
 90006: () => { document.exitFullscreen(); },  
 90033: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 90227: () => { return window.innerWidth; },  
 90253: () => { return window.innerHeight; },  
 90280: () => { if (document.fullscreenElement) return 1; },  
 90326: () => { return Module.canvas.width; },  
 90358: () => { return parseInt(Module.canvas.style.width); },  
 90406: () => { if (document.fullscreenElement) return 1; },  
 90452: () => { return Module.canvas.width; },  
 90484: () => { return screen.width; },  
 90509: () => { return window.innerWidth; },  
 90535: () => { return window.innerHeight; },  
 90562: () => { if (document.fullscreenElement) return 1; },  
 90608: () => { return Module.canvas.width; },  
 90640: () => { return screen.width; },  
 90665: () => { document.exitFullscreen(); },  
 90692: () => { if (document.fullscreenElement) return 1; },  
 90738: () => { return Module.canvas.width; },  
 90770: () => { return parseInt(Module.canvas.style.width); },  
 90818: () => { document.exitFullscreen(); },  
 90845: ($0) => { Module.canvas.style.opacity = $0; },  
 90883: () => { return screen.width; },  
 90908: () => { return screen.height; },  
 90934: () => { return window.screenX; },  
 90961: () => { return window.screenY; },  
 90988: () => { return window.devicePixelRatio; },  
 91024: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91077: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91128: () => { Module.canvas.style.cursor = 'none'; },  
 91165: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91421: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91472: () => { if (document.pointerLockElement) return 1; },  
 91519: () => { if (document.fullscreenElement) return 1; },  
 91565: () => { return window.innerWidth; },  
 91591: () => { return window.innerHeight; }
};
